...
#block(name=descatter, threads=5, memory=5000, subtasks=1, gpu=true, hours=66)
    root_gut="/home/mengqi/fileserver/results/fluorescence/20190812_DRIT/20190813_gut_deblur-A_vessel"  # trained on gut
    root_brain="/home/mengqi/fileserver/results/fluorescence/20190812_DRIT/20190812_unpaired_deblur-A_sharp-B_blur"  # trained on brain
