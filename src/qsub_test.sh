...
#block(name=descatter, threads=5, memory=5000, subtasks=1, gpu=true, hours=66)
    ...
    dataset="test_angiography"  # path: root/method_folder/dataset
        ...
        do
            ...
            do
                ...
                do
                    ...
                    python -u test.py --dataroot $root --result_dir $root/$method_folder/"$dataset"_"$loadSize"_"$fineSize"/ \
                            --name $name \
